...
//     (film.vote_average >= 5) ? 
//     `<div class="bob"><h2>${film.original_title} avec un avis <i class="fa-regular fa-thumbs-up"></i></h2> <img src=https://image.tmdb.org/t/p/w200${film.poster_path}> <p>-> il a une note de ${film.vote_average}</p></div>`: 
//     `<div class="bob"><h2>${film.original_title} avec un avis <i class="fa-regular fa-thumbs-down"></i></h2> <img src=https://image.tmdb.org/t/p/w200${film.poster_path}><p>-> il a une note de ${film.vote_average}</p></div>` 
//     )
// ).join("");
